...
function Loader({width='200px', styleClass}: SvgIconInterface) {
    return (
        <div className={styleClass}>
        <svg viewBox="0 0 100 100" width={width} height={width} xmlns="http://www.w3.org/2000/svg"  preserveAspectRatio="xMidYMid"
        >
